VARS = {
    ...
    "riemann": {
        ...
        "config_url": "https://raw.githubusercontent.com/geokala/cloudify-manager/ipv6mods/plugins/riemann-controller/riemann_controller/resources/manager.config",
        "ports": ["5555"],
    ...
    "celery": {
        ...
        "modules": {
                "cloudify_rest_client": "git+git://github.com/cloudify-cosmo/cloudify-rest-client.git@3.2m8",
                "cloudify_plugins_common": "git+git://github.com/geokala/cloudify-plugins-common.git@ipv6mods",
                "cloudify_script_plugin": "git+git://github.com/cloudify-cosmo/cloudify-script-plugin.git@1.2m8",
                "cloudify_manager": "-b ipv6mods https://github.com/geokala/cloudify-manager.git",
            },
    ...
    "manager": {
        ...
        "modules": {
            "cloudify_rest_client": "git+git://github.com/cloudify-cosmo/cloudify-rest-client.git@3.2m8",
            "cloudify_plugins_common": "git+git://github.com/geokala/cloudify-plugins-common.git@ipv6mods",
            "cloudify_amqp_influxdb": "git+git://github.com/cloudify-cosmo/cloudify-amqp-influxdb.git@3.2m8",
            "cloudify_dsl_parser": "git+git://github.com/cloudify-cosmo/cloudify-dsl-parser.git@3.2m8",
    ...
    "webui": {
        ...
        "ui_package_url": "http://gigaspaces-repository-eu.s3.amazonaws.com/org/cloudify3/3.2.0/m8-RELEASE/cloudify-ui_3.2.0-m8-b178_amd64.deb",
        "ports": ["80"],
    }
}
