VARS = {
    ...
    "riemann": {
        ...
        "config_url": "https://raw.githubusercontent.com/geokala/cloudify-manager/3.2/plugins/riemann-controller/riemann_controller/resources/manager.config",
        "ports": ["5555"],
    ...
    "celery": {
        ...
        "modules": {
                ...
                "cloudify_plugins_common": "git+git://github.com/geokala/cloudify-plugins-common.git@ipv6mods3.2ga",
                "cloudify_script_plugin": "git+git://github.com/cloudify-cosmo/cloudify-script-plugin.git@1.2",
                "cloudify_manager": "-b ipv6mods3.2ga https://github.com/geokala/cloudify-manager.git",
            },
